...
<a href="sun.php"><button>Try Again</button></a>
  <br><br>
...
<div id="myModal" class="modal">
   ...
   <div class="modal-content">
      <h1>Your have completed the second stage of Your Journey</h1>
      <p> Find out what's next, and you might be impressed. <p>
    <p>Click on the button below to begin your Space Travel!<p>
      <button><a href="universe.php">Universe</a></button>
  </div>
  </div>
